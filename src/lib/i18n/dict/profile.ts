...
export const profile: Record<string, Translation> = {
  ...
  '人生主題': { 'zh-CN': '人生主题', en: 'Life themes' },
  '人生主題分布': { 'zh-CN': '人生主题分布', en: 'Life theme distribution' },
  '工作／學業': { 'zh-CN': '工作／学业', en: 'Work / study' },
  '人際關係': { 'zh-CN': '人际关系', en: 'Relationships' },
  '身心健康': { 'zh-CN': '身心健康', en: 'Health' },
  '休息與恢復': { 'zh-CN': '休息与恢复', en: 'Rest & recovery' },
  '自我成長': { 'zh-CN': '自我成长', en: 'Growth' },
  '生活日常': { 'zh-CN': '生活日常', en: 'Daily life' },
  '再多寫幾篇，人生主題分析就會出現': {
    'zh-CN': '再多写几篇，人生主题分析就会出现',
    en: 'Write a few more entries to reveal your life themes',
  },
  '情緒變化': { 'zh-CN': '情绪变化', en: 'Emotional shifts' },
  '本週情緒折線圖': { 'zh-CN': '本周情绪折线图', en: 'Weekly emotion line chart' },
  '正向情緒': { 'zh-CN': '正向情绪', en: 'Positive emotion' },
  '負面情緒': { 'zh-CN': '负面情绪', en: 'Negative emotion' },
  '依日記文字分析情緒效價，0 代表平穩，越高越正向。': {
    'zh-CN': '依日记文字分析情绪效价，0 代表平稳，越高越正向。',
    en: 'Text-based emotional valence: 0 is steady, and higher values are more positive.',
  },
  '再多寫幾篇，情緒趨勢就會出現': {
    'zh-CN': '再多写几篇，情绪趋势就会出现',
  ...
  '正向': { 'zh-CN': '正向', en: 'Positive' },
  '中性': { 'zh-CN': '中性', en: 'Neutral' },
  '負向': { 'zh-CN': '负向', en: 'Negative' },
